...
The site is not fancy by design. What matters is that nothing in the workflow required a human to write code, configure infrastructure, or hand-tune metrics. The operator's role was approvals at the moments the build plan reserved for human judgment.
